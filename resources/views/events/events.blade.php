...
@section("content")
    ...
    <div class="max-w-screen-xl flex flex-wrap items-center mx-auto p-4 justify-center">
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-multi-level">
        <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
          <li>
            <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" class="flex items-center justify-between w-full py-2 px-3 text-black md:hover:bg-transparent md:border-0 md:p-0 md:w-auto">Master Data <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
  ...
  <div class="container p-5">
    <h1 class="font-bold">Events in Surabaya</h1>
